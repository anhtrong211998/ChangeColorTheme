...
namespace ChangeColorTheme.ThemeManager.Extensions
{
    ...
    {
        private const string CurrentThemeKey = $"MaterialDesignThemes.{nameof(CurrentThemeKey)}";
        private const string ThemeManagerKey = $"MaterialDesignThemes.{nameof(ThemeManagerKey)}";
        ...
        public static void SetSolidColorBrush(this ResourceDictionary sourceDictionary, string name, Color value)
        {
